...
public class TestFallaCuit {
    ...
    public static void main(String[] args) {
        try {
            ...
            //Instanciamos lo necesario para un comercio y al comercio pero con cuit erroneo----------------------------
            ...
            Comercio comercio = new Comercio(1, contactoComercio, "Almacen Granate", 20203497384l,
                    10, 10, 6, 40,
                    20);
            //----------------------------------------------------------------------------------------------------------
